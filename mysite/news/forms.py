...
class NewsForm(forms.ModelForm):
    ...
    # category = forms.ModelChoiceField(empty_label='Выберите категория',label='Категория ',queryset=Category.objects.all(),widget=forms.Select(attrs={"class": "form-control"}))
